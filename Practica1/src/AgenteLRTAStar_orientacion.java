...
public class AgenteLRTAStar_orientacion extends AbstractPlayer{
	...
	public AgenteLRTAStar_orientacion(StateObservation stateObs , ElapsedCpuTimer elapsedTimer){
